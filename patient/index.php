                        ...
                        <table class="filter-container doctor-header patient-header" style="border: none;width:95%"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="display:none">Haven't any idea about doctors? no problem let's jumping to
                                    ...
                                    <br>
                                    <h3 style="display:none">Find Your Doctor Here</h3>
                                    <form action="schedule.php" method="post" style="display: flex">

                                        <input type="search" name="search" class="input-text "
                                            placeholder="Type Doctor's Name to Find the Available Session"
                                        ...
                                        <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;">&nbsp; Channel a Doctor &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
