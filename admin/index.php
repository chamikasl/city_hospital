                ...
                <td colspan="4">
                    <table width="100%" border="0" class="dashbord-tables">
                        <tr>
                            ...
                            <td>
                                <p
                                    style="text-align:center;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                        ...
                        <tr>
                            <td width="50%">
                                <center>
                                    <div class="abc scroll" style="height: 280px;">
                            ...
                            <td width="50%" style="padding: 0;">
                                <center>
                                    <div class="abc scroll" style="height: 280px;padding: 0;margin: 0;">
                                        <table width="85%" class="sub-table scrolldown" border="0">
                                            <thead>
                                                <tr>
                                                    <th class="table-headin">
                                            ...
                                            <tbody>
                                                <?php
                                                $nextweek = date("Y-m-d", strtotime("+1 week"));
                                                $sqlmain = "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop,schedule.fee from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc";
                                                $result = $database->query($sqlmain);
