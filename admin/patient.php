                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar"
                            placeholder="Search Patient" list="patient">&nbsp;&nbsp;
                ...
                <td colspan="4">
                    <center>
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" style="border:0;">
                                <thead>
                                    <tr>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=view&id='.$pid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding: 20px; margin-top: 10px; margin-bottom: 10px;"></button></a>
                                        </div>
                                        </td>
                                    </tr>';
