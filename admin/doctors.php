...
<body>
    ...
    <div class="dash-body" style="margin-top:25px;">
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar"
                            placeholder="Search Doctor" list="doctors">&nbsp;&nbsp;
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=view&id='.$docid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding: 20px; margin-top: 10px; margin-bottom: 10px;"></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=edit&id='.$docid.'&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding: 20px; margin-top: 10px; margin-bottom: 10px; "></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=drop&id='.$docid.'&name='.$name.'" class="non-style-link"> <button class="btn-primary-soft btn button-icon btn-delete" style="padding: 20px; margin-top: 10px; margin-bottom: 10px;"></button></a>
